...
function qod_scripts() {
	...
	wp_localize_script('qod_api','red_vars', array(
			'root_url' => esc_url_raw ( rest_url() ),
			'nonce'    => wp_create_nonce ( 'wp_rest' ),
			'success'  => "Thank you. Your quote submission was recieved.",
			'failure'  => "Sorry, your submission was not recieved. Please try again."
		));
